...
They are very close to each other, except testing accuracy holds higher accuracy than average accuracy. This proves that using k-fold cross validation on the datasets leads to greater accuracy with logistic regression models. 